...
class ConversionWeightAdapter(private val conversionList: List<ConversionData>) :
    RecyclerView.Adapter<ConversionWeightAdapter.ConversionViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ConversionViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.conversion_weight_item, parent, false)
